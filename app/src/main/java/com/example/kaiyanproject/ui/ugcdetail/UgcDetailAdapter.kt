...
import com.example.kaiyanproject.ui.community.commend.CommendAdapter
...
class UgcDetailAdapter(
                        ...
                        item.data.content.data.urls?.run {
                            ...
                            if (item.data.content.data.urls.size > 1) {
                                ...
                                holder.tvPhotoCount.text = String.format(
                                    R.string.photo_count.resString,
                                    1,
    ...
    class PhotosAdapter(val dataList: List<String>, val ugcHolder: FollowCardViewHolder) :
