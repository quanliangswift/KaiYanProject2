package com.example.kaiyanproject.ui.common.holder
...
import com.example.kaiyanproject.Const.ItemViewType.Companion.AUTO_PLAY_VIDEO_AD
import com.example.kaiyanproject.Const.ItemViewType.Companion.BANNER
import com.example.kaiyanproject.Const.ItemViewType.Companion.BANNER3
import com.example.kaiyanproject.Const.ItemViewType.Companion.COLUMN_CARD_LIST
import com.example.kaiyanproject.Const.ItemViewType.Companion.FOLLOW_CARD
import com.example.kaiyanproject.Const.ItemViewType.Companion.HORIZONTAL_SCROLL_CARD
import com.example.kaiyanproject.Const.ItemViewType.Companion.INFORMATION_CARD
import com.example.kaiyanproject.Const.ItemViewType.Companion.SPECIAL_SQUARE_CARD_COLLECTION
import com.example.kaiyanproject.Const.ItemViewType.Companion.TAG_BRIEFCARD
import com.example.kaiyanproject.Const.ItemViewType.Companion.TEXT_CARD_FOOTER2
import com.example.kaiyanproject.Const.ItemViewType.Companion.TEXT_CARD_FOOTER3
import com.example.kaiyanproject.Const.ItemViewType.Companion.TEXT_CARD_HEADER4
import com.example.kaiyanproject.Const.ItemViewType.Companion.TEXT_CARD_HEADER5
import com.example.kaiyanproject.Const.ItemViewType.Companion.TEXT_CARD_HEADER7
import com.example.kaiyanproject.Const.ItemViewType.Companion.TEXT_CARD_HEADER8
import com.example.kaiyanproject.Const.ItemViewType.Companion.TOPIC_BRIEFCARD
import com.example.kaiyanproject.Const.ItemViewType.Companion.UGC_SELECTED_CARD_COLLECTION
import com.example.kaiyanproject.Const.ItemViewType.Companion.UNKNOWN
import com.example.kaiyanproject.Const.ItemViewType.Companion.VIDEO_SMALL_CARD
...
import com.example.kaiyanproject.ui.home.discovery.DiscoveryAdapter
...
class TextCardViewFooter2ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    val ivTooterInto2 = view.findViewById<ImageView>(R.id.ivFooterInto2)
}
...
class TextCardViewFooter3ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    val ivTooterInto3 = view.findViewById<ImageView>(R.id.ivFooterInto3)
}
...
object RecyclerViewHelp {
    fun getViewHolder(parent: ViewGroup, viewType: Int) = when (viewType) {
        TEXT_CARD_HEADER4 -> TextCardViewHeader4ViewHolder(
            R.layout.item_text_card_type_header_four.inflate(
                parent
            )
        )

        TEXT_CARD_HEADER5 -> TextCardViewHeader5ViewHolder(
            R.layout.item_text_card_type_header_five.inflate(
                parent
            )
        )
